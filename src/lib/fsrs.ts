const FSRS_PARAMS = {
	w: [0.4072, 1.1829, 3.1262, 15.4722, 7.2102, 0.5316, 1.0651, 0.0589, 1.533, 0.1544, 1.007, 1.9395, 0.11, 0.29, 2.27, 0.25, 2.9898],
...
export function scheduleCard(card: FSRSCard, rating: Rating, reviewDate = new Date()): FSRSResult {
	...
	const nextStability = clamp((normalizedCard.stability * growthFactorMap[rating] * (11 - difficulty)) / 7, 0.5, FSRS_PARAMS.maximumInterval);
