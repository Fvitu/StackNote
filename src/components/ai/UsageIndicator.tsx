...
export function UsageIndicator({ model, category = "text", variant = "compact" }: UsageIndicatorProps) {
	...
	const tokenPercentage = modelUsage.tokens && modelUsage.tokens.limit > 0 ? modelUsage.tokens.used / modelUsage.tokens.limit : 0;
	const flashcardPercentage = modelUsage.flashcards && modelUsage.flashcards.limit > 0 ? modelUsage.flashcards.used / modelUsage.flashcards.limit : 0;
	...
	const audioPercentage = modelUsage.audioSeconds && modelUsage.audioSeconds.limit > 0 ? modelUsage.audioSeconds.used / modelUsage.audioSeconds.limit : 0;
