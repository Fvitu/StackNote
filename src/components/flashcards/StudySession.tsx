...
export function StudySession({ open, sessionId, title, cards, onClose }: StudySessionProps) {
  ...
  return (
    <div className="fixed inset-0 z-[140] flex flex-col bg-[rgba(6,6,8,0.98)] backdrop-blur-md">
      <div className="flex h-14 shrink-0 items-center justify-between border-b px-5" style={{ borderColor: "var(--border-default)" }}>
        <button type="button" onClick={onClose} className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-sm transition-colors hover:bg-[var(--bg-hover)]" style={{ color: "var(--text-secondary)" }}>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-8">
        {currentCard ? (
          <div className="w-full max-w-4xl">
            <div className="rounded-[28px] border px-8 py-10 shadow-[0_24px_80px_rgba(0,0,0,0.35)]" style={{ backgroundColor: "var(--bg-sidebar)", borderColor: "var(--border-default)" }}>
              <div className="min-h-[360px]">
                <div className="flex min-h-[180px] items-center justify-center text-center">
                  <MarkdownContent
                    content={currentCard.front}
                    className="w-full max-w-3xl text-left text-[1.55rem] font-semibold leading-tight tracking-tight text-[var(--text-primary)]"
                  />
                </div>
                  ...
                  <>
                    ...
                    <div className="flex min-h-[140px] items-center justify-center text-center">
                      <MarkdownContent
                        ...
                        className="w-full max-w-3xl text-left text-lg leading-8 text-[var(--text-secondary)]"
                      />
                    </div>
                  </>
                ) : (
          ...
          <div className="rounded-3xl border px-8 py-12 text-center" style={{ backgroundColor: "var(--bg-sidebar)", borderColor: "var(--border-default)" }}>
