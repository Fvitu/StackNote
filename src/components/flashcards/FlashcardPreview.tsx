...
export function FlashcardPreview({ deckId, title, cards, onClose }: FlashcardPreviewProps) {
	...
	return (
		<div
			...
			{/* Header */}
			<div className="flex h-12 shrink-0 items-center justify-between border-b px-4" style={{ borderColor: "var(--border-default)" }}>
				...
				<button onClick={onClose} className="rounded p-1.5 transition-colors hover:bg-[#1a1a1a]">
			...
			<div className="flex-1 px-4 pb-4">
				<div className="perspective-1000 relative h-full cursor-pointer" onClick={flip}>
					<div className={`preserve-3d absolute inset-0 transition-transform duration-500 ${isFlipped ? "rotate-y-180" : ""}`}>
						{/* Front */}
						<div
							...
							<span className="mb-2 text-xs font-medium uppercase tracking-wider" style={{ color: "var(--text-tertiary)" }}>
								Question
							</span>
							<div className="flex flex-1 items-center justify-center text-center text-lg" style={{ color: "var(--text-primary)" }}>
						...
						<div
							...
							<span className="mb-2 text-xs font-medium uppercase tracking-wider" style={{ color: "var(--sn-accent)" }}>
								Answer
							</span>
							<div className="flex flex-1 items-center justify-center text-center" style={{ color: "var(--text-primary)" }}>
