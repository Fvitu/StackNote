...
export const imageMediaBlockSpec = createReactBlockSpec(
  ...
  },
  {
    ...
    render: (props) => {
      ...
      const width = WIDTH_PRESETS.includes(props.block.props.width as (typeof WIDTH_PRESETS)[number])
      ...
      return (
        ...
        >
          <div className={`w-full ${isPreview ? "pointer-events-none select-none" : "group/imageMedia relative"}`} style={containerStyle}>
            {props.block.props.uploading ? (
              <div
                className="overflow-hidden rounded-[var(--sn-radius-lg)] border pulse"
                style={{
              ...
              <div
                className="rounded-[var(--sn-radius-lg)] border px-4 py-8 text-center"
              ...
              >
                ...
                <p className="mt-1 text-xs" style={{ color: "#fecaca" }}>{fileName}</p>
              </div>
            ) : (
              <img
                ref={imageRef}
                ...
                className="w-full rounded-[var(--sn-radius-lg)] border"
              ...
              <>
                ...
                <input
                  ...
                  className={`mt-2 w-full border-none bg-transparent text-center text-xs outline-none transition-opacity duration-150 ${
                    props.block.props.caption ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none group-hover/imageMedia:opacity-100 group-hover/imageMedia:pointer-events-auto"
                  }`}
