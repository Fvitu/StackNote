...
function QuickNoteEditor({
  ...
  onChange: (nextContent: unknown) => void
}) {
    ...
    <div
      ...
      <div
        ...
        <button
          ...
          className="flex h-11 w-[190px] items-center justify-between rounded-full border px-4 text-sm shadow-[0_12px_30px_rgba(0,0,0,0.35)] transition-[transform,colors] duration-200 hover:-translate-y-0.5"
          style={{
      ...
      <div
        ...
        <div
          ...
          <div className="flex h-11 items-center justify-between border-b pl-12 pr-4" style={{ borderColor: "rgba(255,255,255,0.06)", borderBottom: "none" }}>
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold" style={{ color: "var(--text-primary)" }}>
                Quick note
              </span>
              {isOffline ? (
                <span className="inline-flex h-2.5 w-2.5 rounded-full" style={{ backgroundColor: "#f59e0b" }} title="Changes saved locally — will sync when online" />
              ) : null}
              {isSyncing ? (
